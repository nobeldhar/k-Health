...
public class CallsUsersAdapter extends RecyclerView.Adapter<CallsUsersAdapter.ViewHolder> {
    ...
    public CallsUsersAdapter(Context context, List<QBUser> usersList) {
    ...
    @NonNull
    @Override
    public CallsUsersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_opponents_list, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CallsUsersAdapter.ViewHolder holder, int position) {
