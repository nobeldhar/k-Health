...
import com.kpsoftwaresolutions.khealth.ui.adapter.DialogsAdapter;
...
import com.kpsoftwaresolutions.khealth.utils.qb.callback.QbEntityCallbackImpl;
...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
    ...
    private void unsubscribeFromPushes() {
        if (QBPushManager.getInstance().isSubscribedToPushes()) {
            ...
            Log.d(TAG, "unsubscribeFromPushes: notSubscribedToPushes");
    }
