...
import com.kpsoftwaresolutions.khealth.ui.adapter.CallsUsersAdapter;
import com.kpsoftwaresolutions.khealth.ui.adapter.UsersAdapter;
import com.kpsoftwaresolutions.khealth.ui.chat_activities.LoginActivity;
import com.kpsoftwaresolutions.khealth.utils.CollectionsUtils;
import com.kpsoftwaresolutions.khealth.utils.Consts;
import com.kpsoftwaresolutions.khealth.utils.PermissionsChecker;
import com.kpsoftwaresolutions.khealth.utils.PushNotificationSender;
...
public class OpponentsActivity extends CallBaseActivity {
    ...
    private CallsUsersAdapter usersAdapter;
    ...
    private void initUi() {
        usersRecyclerview = findViewById(R.id.list_select_users_call);
    }
    ...
    private void initUsersList() {
        ...
        if (usersAdapter == null) {
            usersAdapter = new CallsUsersAdapter(this, currentOpponentsList);
            usersAdapter.setSelectedItemsCountsChangedListener(new CallsUsersAdapter.SelectedItemsCountChangedListener() {
                @Override
